...
const TraderProfilePage = ({ embedded = false } = {}) => {
  ...
  const courseFallbacks = courses.length > 0 ? courses : [
    { _id: 'technical-analysis-101', title: 'Technical Analysis 101', description: 'Master chart patterns, candlesticks, and indicators.' },
    { _id: 'options-mastery', title: 'Options Mastery', description: 'Deep dive into greeks, spreads, and volatility.' },
  ];
